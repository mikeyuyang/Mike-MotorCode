...
#define PHY_100Base_Full_Duplex         ((uint16_t)0x4000)      /*!< 100BASE-TX Full Duplex */
#define PHY_100Base_Half_Duplex         ((uint16_t)0x2000)      /*!< 100BASE-TX Half Duplex */
#define PHY_10Base_Full_Duplex         ((uint16_t)0x1000)      /*!< 10BASE-TX Full Duplex */
#define PHY_10Base_Half_Duplex         ((uint16_t)0x0800)      /*!< 10BASE-TX Half Duplex */
